...
class LoginWindow(ctk.CTkFrame):
    ...
    def _build_ui(self):
        # ── Branding header ──
        header = ctk.CTkFrame(self, fg_color="#212529", corner_radius=0, height=90)
        header.pack(fill="x")
        ...
        ctk.CTkLabel(
            ...
            font=ctk.CTkFont(size=11), text_color="#868E96",
        ).pack(pady=(2, 10))

        # ── Card frame ──
        card = ctk.CTkFrame(self, fg_color="#212529", corner_radius=16, border_width=1, border_color="#DEE2E6")
        card.pack(padx=40, pady=30, fill="both", expand=True)

        ctk.CTkLabel(
            card, text="Sign In",
            font=ctk.CTkFont(size=20, weight="bold"), text_color="#212529",
        ).pack(pady=(30, 5))
        ctk.CTkLabel(
        ...
        # Username
        ctk.CTkLabel(card, text="Username", font=ctk.CTkFont(size=12), text_color="#495057",
        ...
        self.username_entry = ctk.CTkEntry(
            ...
            fg_color="#F8F9FA", border_color="#DEE2E6", text_color="#212529",
        )
        self.username_entry.pack(padx=30, fill="x", pady=(4, 12))

        # Password
        ctk.CTkLabel(card, text="Password", font=ctk.CTkFont(size=12), text_color="#495057",
                      anchor="w").pack(padx=30, anchor="w")
        ...
        self.status_label = ctk.CTkLabel(
            card, text="", font=ctk.CTkFont(size=11), text_color="#EF233C",
        )
